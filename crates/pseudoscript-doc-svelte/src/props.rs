...
pub(crate) struct PageProps {
    ...
    /// The page body: the index or one module's sections.
    pub page: PageBody,
}

/// Site-wide presentation derived from [`pseudoscript_doc::DocConfig`].
#[derive(Debug, Clone, Serialize)]
#[serde(rename_all = "camelCase")]
pub(crate) struct SiteInfo {
    ...
    /// index, `"../"` for module pages), applied to the brand link and logo.
    pub prefix: String,
}
