...
- **Reserved words.** All §2.3 keywords, the primitive type names (`number`, `string`, `bool`, `datetime`, `uuid`, `void`), `Result`, `Ok`, and `Err` are reserved and MUST NOT be used as identifiers. `data string` / `data Ok` MUST be rejected.
