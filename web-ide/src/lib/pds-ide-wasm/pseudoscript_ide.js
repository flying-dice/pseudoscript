/* @ts-self-types="./pseudoscript_ide.d.ts" */
...
export class IdeSession {
    ...
    check(source) {
        ...
        const ret = wasm.idesession_check(this.__wbg_ptr, ptr0, len0);
     ...
     * @returns {Completion[]}
     */
    completion(fqn, offset) {
        const ptr0 = passStringToWasm0(fqn, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.idesession_completion(this.__wbg_ptr, ptr0, len0, offset);
        var v2 = getArrayJsValueFromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
        return v2;
    }
     ...
     */
    definition(fqn, offset) {
        const ptr0 = passStringToWasm0(fqn, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.idesession_definition(this.__wbg_ptr, ptr0, len0, offset);
        let v2;
        if (ret[0] !== 0) {
     ...
     * @param {string} lock
     * @param {VendoredInput[]} vendored
     * @param {LocalInput[]} local
     * @returns {Module[]}
     */
    dependency_modules(lock, vendored, local) {
        const ptr0 = passStringToWasm0(lock, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArrayJsValueToWasm0(vendored, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passArrayJsValueToWasm0(local, wasm.__wbindgen_malloc);
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.idesession_dependency_modules(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2);
        if (ret[3]) {
    ...
    doc_manifest(toml) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.idesession_doc_manifest(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
    ...
    doc_ssr_bundle() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.idesession_doc_ssr_bundle(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
    ...
    emit_scene(view, target) {
        ...
        try {
            ...
            const len1 = WASM_VECTOR_LEN;
            const ret = wasm.idesession_emit_scene(this.__wbg_ptr, ptr0, len0, ptr1, len1);
            var ptr3 = ret[0];
            var len3 = ret[1];
            if (ret[3]) {
                ptr3 = 0; len3 = 0;
    ...
    format(source) {
        ...
        try {
            const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.idesession_format(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
     ...
     * @param {Module[]} externals
     */
    mount(modules, externals) {
        const ptr0 = passArrayJsValueToWasm0(modules, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArrayJsValueToWasm0(externals, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
     ...
     */
    outline() {
        const ret = wasm.idesession_outline(this.__wbg_ptr);
        var v1 = getArrayJsValueFromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
        return v1;
    }
     ...
     * @param {string} fqn
     * @param {number} offset
     * @returns {References | undefined}
     */
    references(fqn, offset) {
        const ptr0 = passStringToWasm0(fqn, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.idesession_references(this.__wbg_ptr, ptr0, len0, offset);
        return ret;
    }
    /**
     ...
     * @param {RenameSelection[]} selected
     * @returns {RenamedSource[]}
     */
    rename_apply(fqn, offset, new_name, selected) {
        const ptr0 = passStringToWasm0(fqn, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(new_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passArrayJsValueToWasm0(selected, wasm.__wbindgen_malloc);
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.idesession_rename_apply(this.__wbg_ptr, ptr0, len0, offset, ptr1, len1, ptr2, len2);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
        var v4 = getArrayJsValueFromWasm0(ret[0], ret[1]).slice();
     ...
     * @param {DocConfigInput} config
     * @param {Function} render
     * @returns {RenderedFile[]}
     */
    render_doc_site(config, render) {
        const ret = wasm.idesession_render_doc_site(this.__wbg_ptr, config, render);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
        var v1 = getArrayJsValueFromWasm0(ret[0], ret[1]).slice();
    ...
    semantic_tokens(source) {
        const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.idesession_semantic_tokens(this.__wbg_ptr, ptr0, len0);
        return ret;
    }
    /**
    ...
    symbol_scene(fqn) {
        ...
        try {
            const ptr0 = passStringToWasm0(fqn, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.idesession_symbol_scene(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./pseudoscript_ide_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('pseudoscript_ide_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
